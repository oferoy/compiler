...
public class AstExpBinop extends AstExp
{
    ...
    /** Operand types from semantMe (used in irMe for string equality). */
    ...
    public Temp irMe()
    {
        ...
        switch (op)
        {
            ...
            case EQ:    // 6
                boolean bothString = leftType != null && rightType != null
                        && "string".equals(leftType.name) && "string".equals(rightType.name);
                if (bothString) {
                    Ir.getInstance().AddIrCommand(
                        new IrCommandEqStrings(dst, t1, t2));
                } else {
                    Ir.getInstance().AddIrCommand(
